...
for dir in dirs:
    ...
    # sample 110 frames at the stride of 10
    frames = frames[30:1130:5]
    # cut frames after 110
    new_dir = dir + 'rgb_90_stride5/'
    ...
    # sample 110 frames at the stride of 10
    depth_frames = depth_frames[30:1130:5]
    # cut frames after 110
    new_dir = dir + 'depth_90_stride5/'
...
for dir in dirs:
    ...
    gt_110 = gt[30:1130:5]
    np.savetxt(dir + 'groundtruth_90_stride5.txt', gt_110)
