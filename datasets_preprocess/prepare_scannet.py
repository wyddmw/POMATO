...
seq_list = seq_list[::5]       # sample 1/5 subdirs
...
for seq in seq_list:
    ...
    new_color_dir = f"../data/scannetv2/{seq}/color_90_stride5_20scenes"
    new_depth_dir = f"../data/scannetv2/{seq}/depth_90_stride5_20scenes"

    # new_img_pathes = img_pathes[:90*3:3]
    # new_depth_pathes = depth_pathes[:90*3:3]
    # new_pose_pathes = pose_pathes[:90*3:3]

    new_img_pathes = img_pathes[:90*5:5]
    new_depth_pathes = depth_pathes[:90*5:5]
    new_pose_pathes = pose_pathes[:90*5:5]
    ...
    pose_new_path = f"../data/scannetv2/{seq}/pose_90_stride5_20scenes.txt"
