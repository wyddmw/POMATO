...
class BasePCOptimizer (nn.Module):
    ...
    def _init_from_views(self, view1, view2, pred1, pred2,
        ...
        self.adjacent_edges = [f'{i}_{i+1}' for i in range(self.n_imgs-1)]

        # input data
        pred1_pts = pred1['pts3d']
        pred2_pts = pred2['pts3d_in_other_view']
        pred3_pts = pred2['pts3d_dynamic']
        
        # TODO: Jinyuan part
        # pts3d alignment to the same camera intrinsic
        ...
        self.pred_m = NoGradParamDict({ij: pred3_pts[n] for n, ij in enumerate(self.str_edges)})

        self.pred_j_single = pred2_pts
        self.pred_m_single = pred3_pts
        ...
        pred3_conf = pred2['conf_dynamic']  # (Number of image_pairs, H, W)
        ...
        self.conf_j_matching = NoGradParamDict({ij: pred3_conf[n] for n, ij in enumerate(self.str_edges)})
