...
class PairViewer (BasePCOptimizer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # add matching here
        self.matching = [self.pred_m['1_0'], self.pred_m['0_1']]    # [cam1->cam2, cam2->cam1]
        self.depth_proj = [self.pred_j['1_0'], self.pred_j['0_1']]    # [cam1->cam2, cam2->cam1]
        ...
        self.matching = nn.ParameterList(self.matching)
        self.depth_proj = nn.ParameterList(self.depth_proj)
    ...
    def get_matchingmaps(self, raw=False):
        matching = [d.to(self.device) for d in self.matching]
        return matching
    
    def get_depthprojmaps(self, raw=False):
        depth_proj = [d.to(self.device) for d in self.depth_proj]
        return depth_proj
