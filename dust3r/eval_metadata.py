...
dataset_metadata = {
    ...
    'bonn': {
        ...
        'mask_path': None,
        'dir_path_func': lambda img_path, seq: os.path.join(img_path, f'rgbd_bonn_{seq}', 'rgb_90_stride5'),
        'gt_traj_func': lambda img_path, anno_path, seq: os.path.join(img_path, f'rgbd_bonn_{seq}', 'groundtruth_90_stride5.txt'),
        'traj_format': 'tum',
        'seq_list': ["crowd2", "crowd3", "person_tracking2", "synchronous", "synchronous2"],
        'full_seq': False,
        'mask_path_seq_func': lambda mask_path, seq: None,
        'skip_condition': None,
    ...
    'tum': {
        ...
        'gt_traj_func': lambda img_path, anno_path, seq: os.path.join(img_path, seq, 'groundtruth.txt'),
        'traj_format': 'tum',
        'seq_list': None,
        'full_seq': True,
        'mask_path_seq_func': lambda mask_path, seq: None,
    ...
    'sintel': {
        ...
        'traj_format': 'sintel',
        'seq_list': ["alley_1", "alley_2", "cave_4", "market_2",
                     "market_5", "market_6", "mountain_1", "shaman_3", "sleeping_1", "sleeping_2", "temple_2"],
