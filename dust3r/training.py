...
def get_args_parser():
    ...
    # model and criterion
    parser.add_argument('--model', default="AsymmetricMASt3R(pos_embed='RoPE100', patch_embed_cls='ManyAR_PatchEmbed', \
                        img_size=(512, 512), head_type='dpt', output_mode='pts3d', depth_mode=('exp', -inf, inf), conf_mode=('exp', 1, inf), \
                        enc_embed_dim=1024, enc_depth=24, enc_num_heads=16, dec_embed_dim=768, dec_depth=12, dec_num_heads=12, freeze='encoder', dynamic_matching=True)",
    ...
    parser.add_argument('--pose_end_frame', default=0, type=int, help='end frame index for a video sequence')
    ...
    parser.add_argument('--adjacent_intervals', type=int, default=10, help='Number of intervals for adjacent pairs')
    ...
    parser.add_argument('--flow_loss_thre', default=30, type=float, help='threshold for flow loss')
    ...
    parser.add_argument('--eval_dataset', type=str, default='sintel', 
                    choices=['davis', 'kitti', 'bonn', 'scannet', 'tum', 'nyu', 'sintel', 'shibuya'], 
